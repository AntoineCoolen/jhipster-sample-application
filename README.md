...
To build the final jar and optimize the OnlineShop application for production, run:
...
Then navigate to [http://localhost:8017](http://localhost:8017) in your browser.
